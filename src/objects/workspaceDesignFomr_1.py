...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\ui\\../../resources/icons/cursor.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.DeleteWidgetButton.setIcon(icon3)
...
"}")
        ...
        self.DragOnGWButton.setIcon(icon4)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(".\\ui\\../../resources/icons/magnifying-glass-2.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(".\\ui\\../../resources/icons/magnifying-glass.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.CloseWorkspaceButton.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(".\\ui\\../../resources/icons/close-button.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.CloseWorkspaceButton.setIcon(icon7)
        self.CloseWorkspaceButton.setIconSize(QtCore.QSize(15, 15))
...
"Click here to zoom out."))
        ...
        self.CloseWorkspaceButton.setToolTip(_translate("WorkspaceDesignForm", "Closes the workspace"))
